...
const Contact = () => {
	return (
		<div
			name="contact"
			className="w-full   mt-20 lg:mt-40 text-white"
		>
			<div className="flex flex-col p-4 justify-center mx-auto h-full">
				...
				<div className=" flex justify-center items-center">
					...
					>
						...
						<button className="mt-10 group relative min-h-[50px] w-40 overflow-hidden border border-purple-500 rounded-3xl text-purple-500 shadow-2xl transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-purple-500 before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-purple-500 after:duration-500 hover:text-white hover:before:h-full hover:after:h-full">
