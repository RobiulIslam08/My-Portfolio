...
const Footer = () => {
	return (
		<div>
			<footer className="footer mt-28 lg:mt-32 pb-10 text-neutral-content items-center p-4">
  <aside className="grid-flow-col items-center">
	...
	<p className="font-signature text-3xl font-bold text-gradient-to-r from-indigo-500">Robi</p>
